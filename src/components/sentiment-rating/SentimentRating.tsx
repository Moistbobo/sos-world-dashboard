      ...
      >
        ...
        >
          ...
          >
            {goodPercent > 0 && (
              <span
                className={`flex h-full items-center justify-center text-[40%] font-bold ${
                  isGoodActive ? 'text-emerald-900 dark:text-emerald-950' : 'text-white'
                }`}
              >
                {goodPercent}%
              </span>
          ...
          >
            {badPercent > 0 && (
              <span
                className={`flex h-full items-center justify-center text-[40%] font-bold ${
                  isBadActive ? 'text-rose-900 dark:text-rose-950' : 'text-white'
                }`}
              >
                {badPercent}%
              </span>
