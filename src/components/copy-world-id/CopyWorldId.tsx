...
export function CopyWorldId({ worldId }: CopyWorldIdProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded text-left transition-colors hover:text-indigo-600 focus-visible:text-indigo-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 dark:hover:text-indigo-400 dark:focus-visible:text-indigo-400"
